...
public class LogEulerSchemeForBlackScholes extends AbstractProcessSimulation {
	...
	/**
	 * It constructs an object of type LogEulerSchemeForBlackScholes, which provides the Euler scheme for the
	 * logarithm of the Black-Scholes model, and transforming back using the exponential.
	 * 
